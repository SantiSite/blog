    ...
    <div className="mb-8 rounded-lg bg-white pb-12 shadow-lg lg:p-8">
      <div className="relative mb-6 overflow-hidden shadow-md">
        <img
          ...
          alt={post.title}
          className="h-full rounded-t-lg object-top"
        />
      </div>
      <div className="px-4 lg:px-0">
        <div className="mb-8 flex w-full items-center justify-center lg:justify-start">
          <div className="mb-auto mr-8 flex w-full items-center md:justify-center lg:mb-0 lg:w-auto">
            <img
          ...
          <div className="font-medium text-gray-700 w-full flex justify-center item-center lg:w-auto lg:inline-block">
            <svg
